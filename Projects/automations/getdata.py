...
# by pressing ctrl + shift + c and then you can use your mouse to find the
...
driver = webdriver.Chrome("/manny/chromedriver_linux64/chromedriver", options=options)
driver.get(config('GROCERY_STORE'))
...
search_site = driver.find_element_by_id("search")
search_site.send_keys('Pampers baby-dry')
search_site.submit()

results = driver.find_elements_by_id('kuLandingProductsListUl')

# select city
button = driver.find_element_by_xpath('/mcard')
button.click()
